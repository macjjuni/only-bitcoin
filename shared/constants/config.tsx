...
const favoriteRouteList = clientRoutes.filter(({ title, isFavorite, ...restProps }) => isFavorite && restProps)
export const navigationRouteList = clientRoutes.filter(({ title, isNav, ...restProps }) => isNav && restProps)

export default { clientRoutes, favoriteRouteList, navigationRouteList }
