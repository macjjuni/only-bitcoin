...
const PWAInstallAlertBottomSheet = () => {
...
const MemoizedPWAInstallAlertBottomSheet = memo(PWAInstallAlertBottomSheet);
MemoizedPWAInstallAlertBottomSheet.displayName = 'PWAInstallAlertBottomSheet';
PWAInstallAlertBottomSheet.displayName = 'PWAInstallAlertBottomSheet';

export default MemoizedPWAInstallAlertBottomSheet