...
const Btc2FiatPage = withSuspense(lazy(() => import("@/pages/btc2krw/btc2krw")));
...
export const routesWithIcon: IRoute[] = [
  ...
  { id: 1, title: "비트코인 계산기", path: "/btc2krw", component: <Btc2FiatPage />, icon: <TransIcon color="#eee" size={28} /> },
