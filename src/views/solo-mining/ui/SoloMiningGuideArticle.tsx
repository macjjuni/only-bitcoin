      ...
      <CardContent className="flex flex-col gap-4 p-4">
        ...
        <section className="flex flex-col gap-1.5">
          ...
          <p className="text-sm leading-relaxed text-muted-foreground">
            블록 하나를 찾으려면 평균적으로 <b>난이도 × 2³²</b> 번의 해시를 시도해야 합니다. 여기에
            내 해시레이트를 나누면 블록 1개까지의 평균 소요 시간이 나옵니다. 네트워크 해시레이트는
            관측된 블록 생성 시간에서 역산한 추정치라 단기 변동이 크지만, 난이도는 프로토콜이 확정한
            값이라 계산 기준으로 더 정확합니다.
          </p>
        </section>

        <section className="flex flex-col gap-1.5">
          <h3 className="text-sm font-bold">기간별 확률은 포아송 분포를 씁니다</h3>
          <p className="text-sm leading-relaxed text-muted-foreground">
            블록 발견은 서로 독립적인 사건이라 기대 발견 횟수를 λ 라 할 때 해당 기간에 최소 1개를
            찾을 확률은 <b>1 - e^(-λ)</b> 입니다. 확률을 두 배 기간으로 늘려도 두 배가 되지 않는
            이유입니다.
          </p>
        </section>
        ...
        <section className="flex flex-col gap-1.5">
          <h3 className="text-sm font-bold">풀 마이닝과 무엇이 다른가요?</h3>
          <p className="text-sm leading-relaxed text-muted-foreground">
