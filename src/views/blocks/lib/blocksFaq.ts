 ...
 * `/blocks` 문답 구조화 데이터.
 *
 * **`<BlocksGuideArticle>` 의 화면 문구와 같아야 함. 한쪽만 고치지 말 것.**
 * 화면에 없는 내용을 구조화 데이터에 넣으면 구글 정책 위반임.
 */
export const BLOCKS_FAQ: readonly FaqItem[] = [
  {
    question: "비트코인 블록이란?",
    answer:
  ...
  {
    question: "채굴(Mining)은 어떻게 이뤄지나요?",
    answer:
  ...
  },
  {
    ...
    answer:
      ...
      "급하지 않은 거래라면 네트워크가 한산한 시간대에 낮은 수수료로 보내고, 빠른 확정이 필요하면 높은 수수료를 지불하는 식으로 조절할 수 있습니다. 위의 실시간 트랜잭션 수수료 정보를 참고하면 적절한 수준을 가늠하는 데 도움이 됩니다.",
  },
];
