...
export default function EtfGuideArticle() {
  return (
    <GuideArticle title="ETF 데이터는 어떻게 읽어야 하나요?" className="w-full font-pretendard">
      ...
      <GuideSection title="왜 최신 날짜가 아닌 기준일을 사용하나요?">
        <GuideParagraph>
          ETF마다 파일 공개 시점이 달라 최신 날짜에 일부 종목만 존재할 수 있습니다. 일부 응답을 전체
          시장처럼 합산하지 않도록 추적 중인 ETF가 모두 존재하는 최근 거래일을 기준일로 사용합니다.
        </GuideParagraph>
      </GuideSection>

      <GuideSection title="비정상 흐름은 어떻게 처리하나요?">
        <GuideParagraph>
      ...
      <GuideWarningBox title="출처 및 유의사항">
