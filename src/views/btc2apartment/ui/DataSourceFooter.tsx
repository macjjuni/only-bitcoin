...
import { CollapseSection, GuideArticle } from "@/shared/ui";
...
const DataSourceFooter = ({ archiveGeneratedAt }: DataSourceFooterProps) => {
  return (
    <GuideArticle title="데이터 출처 및 산정 기준">
      <CollapseSection
        title={<span className="text-base font-bold">상세 보기</span>}
      ...
      >
        ...
        <div className="flex flex-col gap-1">
          ...
          <ul className="flex flex-col gap-0.5 pl-3 list-disc text-sm opacity-80">
            ...
            <li>
              연 거래 {MIN_RELIABLE_DEAL_COUNT}건 미만인 해는 중앙값이 통계보다 우연에 가까워 툴팁에
              &lsquo;표본 부족&rsquo;으로 표시합니다
            </li>
          </ul>
        </div>
