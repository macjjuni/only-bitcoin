...
const NaverIcon = ({ size = "100%", color = "currentColor", style }: IconTypes) => {
  return (
    <svg viewBox="-32 0 512 512" width={size} height={size} version="1.1" xmlns="http://www.w3.org/2000/svg" fill={color} style={style}>
      <g strokeWidth="0"/>
