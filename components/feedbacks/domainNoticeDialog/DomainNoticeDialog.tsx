        ...
        <div className="py-2 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2 p-4 bg-gray-50 dark:bg-neutral-800 border-border rounded-lg border">
            <div className="flex justify-between text-sm">
              ...
              <span className="line-through text-gray-400 italic font-light">
                https://btc-price.web.app
              </span>
            </div>
            <div className="flex justify-between font-bold text-base">
              <span>신규 주소</span>
              <span className="text-blue-600 underline underline-offset-4">
                <a href="https://only-btc.app" target="_blank" rel="noreferrer">
                  https://only-btc.app
                </a>
              </span>
            </div>
          ...
          <div className="text-[0.925rem] leading-relaxed text-gray-700 dark:text-neutral-300 space-y-3 px-2 tracking-tight">
            <p>
              더 나은 환경을 위해 서비스 주소가 변경되었습니다. 기존 주소는 자동으로 이동되지만,
              기존 설정값은 보안상 이전되지 않습니다. 원활한 이용을 위해 새로운 주소에서{" "}
              <strong>설치 및 재설정</strong>을 진행해 주시길 부탁드립니다.
            </p>
          </div>
        </div>
